...
function parseFiltersFromParams(params: URLSearchParams): ListingFilters {
...
function filtersToParams(filters: ListingFilters, sortBy: SortOption): URLSearchParams {
