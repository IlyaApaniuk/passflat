...
- **Deposit amount and terms** — by law, the deposit (kaucja) cannot exceed twelve times the monthly rent, though one or two months is standard. Passflat data puts the median Warsaw deposit at 5 000 zł, and in 77% of tenant reports it was returned in full. Confirm in writing the conditions under which it will be returned — more in our [guide to the rental deposit (kaucja)](https://passflat.com/en/blog/rental-deposit-kaucja-warsaw). How to pay the deposit and first rent before you have a Polish bank account is covered in our [guide to banks and Wise](/en/blog/bank-account-rent-poland).
