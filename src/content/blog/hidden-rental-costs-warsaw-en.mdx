...
**Heating (ogrzewanie):** In buildings with district heating (*miejska sieć ciepłownicza*), heating is often bundled into the admin fee as a flat advance payment (*zaliczka na ogrzewanie*). You'll pay a settled amount monthly, with an annual reconciliation that can result in a refund or a top-up. Expect an extra 150–400 PLN/month during the heating season (October–April). How the rozliczenie works and how to check that a top-up bill was calculated fairly is covered in our [dedicated dopłaty guide](/en/blog/doplaty-rozliczenie-warsaw).

**Internet:** A standard fiber connection in Warsaw runs 50–80 PLN/month. Some buildings have a deal with a specific provider, so check what's available before signing up elsewhere. How to check fiber coverage before you sign the lease — and what to do with the provider contract when you move out — is covered in our [home internet guide](/en/blog/internet-apartment-warsaw).
