...
Protect yourself: at move-in, complete a **protokół zdawczo-odbiorczy** (handover report) with photos and meter readings, attached to the contract. Without the report, you'll almost always lose a deposit dispute. What exactly to record, point by point, is in our [20-point handover protocol guide](/en/blog/protokol-zdawczo-odbiorczy-warsaw). In tenant reports on Passflat, the median Warsaw deposit is about 5 000 zł, and 77% of tenants get it back in full — what separates them from the rest is, above all, a handover report with recorded meter readings. More in [our guide to getting the kaucja back](/en/blog/rental-deposit-kaucja-warsaw).
