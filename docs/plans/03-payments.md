...
> **⚠️ ЗАПАРКОВАНО (2026-06-21).** Весь план построен на листинг-маркетплейс монетизации (promoted listings, P2P-субаренда escrow, PRO-аккаунты) — она **ЗАПАРКОВАНА**. Текущие движки выручки: cost-data B2C (отчёт ~15zł / подписка ~35zł / relocation ~60zł) + агентский B2B (позже). Feature-freeze — не строить. Оставлено как исторический референс.
